...
$(document).ready(function() {
    ...
    for(let j=0; j<6; j++) {
        $(fullMergedArray[j]).click(function(){
            $("html, body").animate({
    ...
    let sideScrollToArray = ["#collapseJobs", "#collapseEducation", "#contactFooter", "#about", "#about", "#projects"];
    ...
    for(let j=0; j<6; j++) {
        $(sideFullMergedArray[j]).click(function(){
            $("html, body").animate({
